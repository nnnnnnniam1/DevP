						...
						<div class="row mb-3">
							...
							<div class="col-sm-9">
								<input class="form-control" type="email"
									placeholder="devp@devp.com" name="email">
							</div>
						</div>
						<div class="row mb-3">
					...
					<div>
						<form class="codeForm findForm" method="post"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-7">
									<input class="form-control" type="text" name="input-code"
										id="input-code">
								</div>
								<div class="col-sm-2">
									<input class="form-control check-code formBtn" type="submit"
										value="인증"><br>
								</div>
							</div>
						...
						<div class="mb-3">
							<input class="form-control" type="button" id="resetPwButton"
								value="비밀번호 재설정">
						</div>
					</div>
				</div></li>
...
<script>
	...
	var findIdInputs = document
			.querySelectorAll('.searchForm.find-id .form-input');
	var findPwInputs = document
			.querySelectorAll('.searchForm.find-pw .form-input');
	var success = false;
	...
	document
			.querySelector('.searchForm.find-pw form')
			.addEventListener(
					'submit',
					function(e) {
	...
	document.querySelector('.searchForm.find-pw .codeForm').addEventListener(
			'submit', function(e) {
				// Prevent the default form submission behavior
				e.preventDefault();
	...
	document.getElementById("resetPwButton").addEventListener('click',
			function() {
